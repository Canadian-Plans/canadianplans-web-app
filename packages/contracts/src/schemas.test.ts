...
const cases: ReadonlyArray<readonly [string, z.ZodType, unknown]> = [
  ...
  ['createQuoteRequest', createQuoteRequestSchema, { productId: UUID_A, form }],
  [
    'createQuoteResponse',
    createQuoteResponseSchema,
    {
  ...
  [
    ...
    getWorkspaceOrderResponseSchema,
    {
      order: {
        ...
        partnerCode: null,
        snapshot,
        history: [{ at: NOW, actorId: UUID_C, action: 'created' }],
      },
      requestId: UUID_C,
    },
  ],
  ...
  [
    ...
    patchWorkspaceOrderResponseSchema,
    {
      order: { ...orderSummary, assigneeId: UUID_C, partnerCode: 'PART1', snapshot, history: [] },
      requestId: UUID_C,
    },
  ],
  [
